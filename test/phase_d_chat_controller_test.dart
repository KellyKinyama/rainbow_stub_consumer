...
void main() {
  ...
  test('chatControllerCapsule renders local echo as flutter_chat_core Message', () async {
  ...
  test('chatControllerCapsule appends incoming XMPP messages for the thread', () async {
    final threadKey = 'bob@localhost';
    final controller = container.read(chatControllerCapsule(threadKey));
  ...
  test('dedupes when a local send is echoed back as a carbon with the same id', () async {
    final threadKey = 'bob@localhost';
    final controller = container.read(chatControllerCapsule(threadKey));
    final peer = RainbowUser(id: 'bob', loginEmail: 'bob@localhost');
  ...
  test('messagesCapsule and chatControllerCapsule stay in sync across the same thread', () async {
    final threadKey = 'bob@localhost';
    final controller = container.read(chatControllerCapsule(threadKey));
